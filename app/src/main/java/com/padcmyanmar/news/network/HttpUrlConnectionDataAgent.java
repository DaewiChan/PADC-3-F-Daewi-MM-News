...
public class HttpUrlConnectionDataAgent implements NewsDataAgent {
    ...
    private static HttpUrlConnectionDataAgent sObiInstance;
    ...
    public static HttpUrlConnectionDataAgent getsObiInstance(){
        if (sObiInstance==null){
            sObiInstance=new HttpUrlConnectionDataAgent();
        }
        return sObiInstance;
    }
